import React__default, { useCallback, useState, useRef, createElement, Fragment, useEffect, useLayoutEffect } from 'react';
...
function Layer({
  ...
  return createElement(Fragment, null, createPortal(children, element));
}
...
function ToggleLayer({
  ...
  const calculateNewLayerStyle = useCallback(() => {
    /**
     * A.
  ...
  const containerElement = typeof container === "function" ? container() : container;
  return createElement(Fragment, null, createElement(Fragment, null, children({
    isOpen,
    close: () => {
      /* istanbul ignore next */
  ...
  }), relativeParentElement && createElement(Layer, {
...
export { ToggleLayer, useHover, Anchor as anchor };
